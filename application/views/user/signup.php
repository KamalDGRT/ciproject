...
<?php echo form_input(['type' => 'date', 'name'=>'dob','id'=>'dob','class'=>'form-control','autofocus'=>'autofocus','value'=>set_value('dob')]);?>
<?php echo form_label('Enter your DOB', 'dob'); ?>
<?php echo form_error('firstname',"<div style='color:red'>","</div>");?>
...
<?php echo form_input(['name'=>'lastname','id'=>'lastname','class'=>'form-control','autofocus'=>'autofocus','value'=>set_value('pincode')]);?>
<?php echo form_label('Enter your Pincode', 'lastname'); ?>
<?php echo form_error('lastname',"<div style='color:red'>","</div>");?>
